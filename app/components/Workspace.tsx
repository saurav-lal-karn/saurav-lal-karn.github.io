...
Command: npx gltfjsx@6.5.3 public/models/workspace-new-1.glb --types --typescript 
*/
...
export function FinalWorkspace(
  ...
  return (
    <group {...restProps} dispose={null}>
      ...
      <group position={[0.958, 0, 0]} scale={[2.053, 1, 1]} name="floormat">
        <mesh
